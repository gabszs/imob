...
- **Profile Pixel**: Automatic name population from user profiles
...
- **Social OAuth**: Google and GitHub provider pixel
...
- **Proper Database Pixel**: Uses the D1 database created by alchemy state stored in `.alchemy/` directory
