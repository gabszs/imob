...
function FeatureCard({
	...
	return (
		<div className="group relative overflow-hidden border-2 border-border/50 bg-linear-to-br from-white/60 to-white/40 p-6 backdrop-blur-sm transition-all hover:border-orange-500/50 dark:from-black/30 dark:to-black/20">
			...
			<h3 className="mb-3 font-bold font-mono text-base uppercase tracking-widest">{title}</h3>
			<p className="font-mono text-muted-foreground text-xs leading-relaxed">{description}</p>
		</div>
	);
}
	...
	return (
		<div className="relative h-full w-full p-4">
			...
			>
				{/* Grid background */}
				<defs>
					<pattern id="grid-mcp" width="20" height="20" patternUnits="userSpaceOnUse">
						<path
							d="M 20 0 L 0 0 0 20"
							fill="none"
							stroke="currentColor"
				...
				<g>
					...
					{/* Status badge */}
					<rect x="95" y="58" width="42" height="15" rx="2" fill="#f97316" opacity="0.9" />
					<text
						x="116"
						y="69"
						textAnchor="middle"
				...
				{[
					...
					<rect key={line.id} x="30" y={line.y} height="6" rx="1.5" fill="#c2410c" opacity="0">
						<animate
							attributeName="width"
	...
	return (
		<div className="relative h-full w-full p-4">
			...
			>
				{/* Grid background */}
				<defs>
					<pattern id="grid-do" width="20" height="20" patternUnits="userSpaceOnUse">
						<path
							d="M 20 0 L 0 0 0 20"
							fill="none"
							stroke="currentColor"
	...
	return (
		<div className="relative h-full w-full p-4">
			...
			>
				{/* Grid background */}
				<defs>
					<pattern id="grid-byok" width="20" height="20" patternUnits="userSpaceOnUse">
						<path
							d="M 20 0 L 0 0 0 20"
							fill="none"
							stroke="currentColor"
				...
				{/* Keyhole */}
				<circle cx="100" cy="118" r="7" fill="currentColor" className="text-orange-500">
					<animate attributeName="opacity" values="0.5;1;0.5" dur="2s" repeatCount="indefinite" />
				</circle>
				<rect x="96" y="125" width="8" height="16" fill="currentColor" className="text-orange-500">
					<animate attributeName="opacity" values="0.5;1;0.5" dur="2s" repeatCount="indefinite" />
				</rect>
