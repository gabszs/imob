		...
		<div className="flex items-center justify-between rounded border p-2">
			<div className="flex items-center gap-2">
				...
				<span className="text-sm">
					{deviceInfo.isLoading ? "Loading..." : deviceInfo.data || "Unknown Device"}
				</span>
				{isCurrentSession && (
...
export function SessionManager() {
	...
	const validSessions = (sessions.data || []).filter((session) => session.userAgent != null);
	...
	return (
		<div className="flex w-full flex-col gap-3">
			...
			{sessions.isLoading ? (
				...
				<p className="text-muted-foreground text-xs">No active sessions found.</p>
			) : (
