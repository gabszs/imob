...
export function ProviderRow({ provider, hasUserKey, onAddKey }: ProviderRowProps) {
	return (
		<div className="flex flex-col gap-3 border bg-background/60 p-4 md:flex-row md:items-center md:justify-between">
			<div className="flex-1 space-y-1">
				...
				{provider.appProvided ? (
					...
					<p className="text-muted-foreground text-xs">Add your API key to unlock these models</p>
				)}
			</div>
			<Button
