		...
		<div className="min-h-screen">
			<div className="mx-auto max-w-4xl px-8 py-32">
				<header className="mb-24">
					<h1 className="font-normal text-xl uppercase tracking-wide">PRIVACY POLICY</h1>
					<p className="mt-1 text-sm italic opacity-80">LAST UPDATED: OCTOBER 2025</p>
				</header>
				...
				<div className="space-y-12 text-base leading-snug">
					<section>
						...
						<div className="space-y-4 opacity-90">
							<p>
								We value your privacy and are committed to safeguarding your personal data. This
								privacy policy explains how Better Chat collects, uses, stores, and protects your
								information when you use our AI chat application, as well as your privacy rights and
								how they are protected by law.
							</p>
							<p>
								Better Chat is built with privacy-first architecture that provides per-user data
						...
						<div className="space-y-4 opacity-90">
							<div>
								...
								<ul className="ml-4 space-y-1">
									...
									<li>→ OAuth tokens (when using Google or GitHub sign-in, stored securely)</li>
								</ul>
							</div>
							...
							<div>
								...
								<ul className="ml-4 space-y-1">
									<li>
										→ Chat conversations and messages (stored in your isolated Durable Object)
									</li>
									<li>→ Conversation titles and timestamps</li>
									<li>
										→ Usage statistics (message counts, token usage per model, daily/monthly
										aggregates)
									</li>
								</ul>
							</div>
							...
							<div>
								<p className="mb-2 font-normal">API Keys (BYOK - Bring Your Own Key)</p>
								<ul className="ml-4 space-y-1">
					...
					<section>
						<h2 className="mb-4 font-normal uppercase">How We Store Your Data</h2>
						<div className="space-y-4 opacity-90">
							<p>
								Better Chat uses secure cloud infrastructure designed for privacy, security, and
								performance:
							</p>
							...
							<div>
								<p className="mb-2 font-normal">Chat Data (Per-User Isolated Storage)</p>
								<ul className="ml-4 space-y-1">
							...
							<div>
								...
								<ul className="ml-4 space-y-1">
									<li>→ API keys encrypted using industry-standard encryption</li>
					...
					<section>
						...
						<div className="space-y-4 opacity-90">
							...
							<p>
								We do not use your data for advertising, marketing, or any purpose beyond operating
								the Better Chat service.
							</p>
						</div>
					</section>

					<section>
						<h2 className="mb-4 font-normal uppercase">Sharing & Third Parties</h2>
						<div className="space-y-4 opacity-90">
							<p>
								We do not sell, lease, or trade your personal information. We share data only with
							...
							<div>
								...
								<ul className="ml-4 space-y-1">
									<li>
										→ Cloud hosting and database services for storing and processing your data
									</li>
							...
							<div>
								...
								<ul className="ml-4 space-y-1">
									<li>→ Email service providers for sending verification codes</li>
								</ul>
							</div>
							...
							<div>
								...
								<ul className="ml-4 space-y-1">
									...
									<li>
										→ When using your own API keys, your keys connect directly to your chosen
										providers
									</li>
									<li>→ Documentation servers (only when you enable them in settings)</li>
									<li>→ Conversation context is sent to AI providers only to generate responses</li>
								</ul>
							</div>

							<p>
								All third-party providers are selected for their strong privacy practices and
					...
					<section>
						...
						<div className="space-y-4 opacity-90">
							...
							<div>
								...
								<ul className="ml-4 space-y-1">
									<li>→ View all your conversations, settings, and usage data through the app</li>
							...
							<div>
								...
								<ul className="ml-4 space-y-1">
									...
									<li>→ Modify your preferences and enabled services anytime</li>
								</ul>
							</div>

							<div>
								<p className="mb-2 font-normal">Deletion (Right to be Forgotten)</p>
								<ul className="ml-4 space-y-1">
									<li>→ Delete individual conversations from your chat history</li>
									<li>
										→ Delete your entire account using the "Delete Account" button in profile
										settings
									</li>
									<li>
										→ Account deletion removes all associated data including conversations,
										settings, and usage history
									</li>
									<li>→ Sessions are automatically deleted upon logout or expiration</li>
								</ul>
							</div>
							...
							<div>
								...
								<ul className="ml-4 space-y-1">
									...
									<li>→ Request data export in machine-readable format by contacting us</li>
								</ul>
							</div>
					...
					<section>
						<h2 className="mb-4 font-normal uppercase">Data Retention & Deletion</h2>
						<div className="space-y-4 opacity-90">
							<ul className="ml-4 space-y-1">
								<li>→ Active accounts: Data retained as long as your account is active</li>
								<li>→ Account deletion: All data permanently deleted within 30 days</li>
								<li>→ Sessions: Automatically expire and are deleted after 30 days</li>
								<li>→ Verification codes: Deleted immediately after use or expiration</li>
								<li>→ Usage limits reset: Daily at 00:00 UTC, monthly on the 1st</li>
								<li>→ User data isolated and deleted when account is removed</li>
							</ul>
						</div>
					</section>
					...
					<section>
						...
						<div className="space-y-4 opacity-90">
							<p>
								Better Chat uses only essential cookies necessary for authentication and session
								management:
							</p>
							<ul className="ml-4 space-y-1">
							...
							<p>
								All cookies are secure, HTTP-only, and use SameSite protection. We do not use
								cookies for advertising, analytics, or tracking across websites.
							</p>
						</div>
					</section>

					<section>
						<h2 className="mb-4 font-normal uppercase">International Data Transfers</h2>
						<div className="space-y-4 opacity-90">
							<p>
								Better Chat is deployed on a global network infrastructure. Your data may be
								processed in data centers close to your geographic location for optimal performance.
								Our infrastructure providers comply with GDPR, CCPA, and other international data
					...
					<section>
						...
						<div className="space-y-4 opacity-90">
							<p>
								Better Chat is not intended for users under 13 years of age. We do not knowingly
					...
					<section>
						<h2 className="mb-4 font-normal uppercase">Changes to This Policy</h2>
						<div className="space-y-4 opacity-90">
							<p>
								We may update this privacy policy from time to time to reflect changes in our
								practices or for legal reasons. Any changes will be posted on this page with an
								updated "Last Updated" date. Continued use of Better Chat after changes indicates
					...
					<section>
						...
						<div className="space-y-4 opacity-90">
							...
							<ul className="ml-4 space-y-1">
								<li>
									→ Email:{" "}
									<a href="mailto:privacy@better-cloud.dev" className={subtleLinkClass}>
					...
					<section className="mt-16 border-current/10 border-t pt-12">
						<div className="text-sm italic opacity-70">
							<p>
								By using Better Chat, you acknowledge that you have read and understood this Privacy
